...
function nextQuestion() { // habilita el boton y todo lo necesario para pasar a la siguiente pregunta
...
async function ChargeImage(pokename) {
  pokemon_img.src = "images/icons/loading.gif"
let response = await fetch(`https://pokeapi.co/api/v2/pokemon/${pokemonSelected.id}`)
